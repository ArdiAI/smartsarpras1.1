...
-- Staff Sarpras:       137e85e7-3ce7-4b7e-bda8-d4b54e67c353
...
BEGIN
  ...
  VALUES ('Workflow Barang', 'Alur persetujuan peminjaman barang: Pembina -> Wakasek Kesiswaan -> PJ Sarpras -> PJ Barang -> Staff Sarpras', true)
  ...
  INSERT INTO workflow_steps (workflow_template_id, step_order, role_id, step_label, is_info_only) VALUES
    ...
    (v_barang_tpl_id, 5, '137e85e7-3ce7-4b7e-bda8-d4b54e67c353', 'Persetujuan Staff Sarpras', false);

  -- 2) Create Workflow Fasilitas template
  INSERT INTO workflow_templates (name, description, is_active)
  VALUES ('Workflow Fasilitas', 'Alur persetujuan peminjaman fasilitas: Pembina -> Wakasek Kesiswaan -> PJ Sarpras -> PJ Fasilitas -> Staff Sarpras', true)
  ON CONFLICT (name) DO UPDATE SET description = EXCLUDED.description, is_active = true, updated_at = now()
  ...
  INSERT INTO workflow_steps (workflow_template_id, step_order, role_id, step_label, is_info_only) VALUES
    ...
    (v_fasilitas_tpl_id, 5, '137e85e7-3ce7-4b7e-bda8-d4b54e67c353', 'Persetujuan Staff Sarpras', false);
