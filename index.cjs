...
// Registered users are stored in app_users.
// Admin access is granted by linking an app_user to admin_users + role.
// =====================================================
...
// Admin masih boleh membuat akun dari panel,
// tetapi alur utama pengguna adalah daftar sendiri di /auth.
app.post(
  '/api/admin/users',
  requireAdmin,
